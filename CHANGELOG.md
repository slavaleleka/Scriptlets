...
The value of the `$redirect` modifier must be the name of the resource that will be used for redirection. See the list
of [available redirect resource](https://github.com/AdguardTeam/Scriptlets/blob/master/wiki/about-redirects.md#redirect-resources).
